...
class Exercise:
    ...
    def __str__(self):
        return "{} {} {} {}".format(
            self.name, self.category, self.description, self.link
        )
...
class Workout:
    ...
    def __init__(
        self, file_name, categories=["upper body", "lower body", "full body", "wod"]
    ):
    ...
    def generate_random_workout(self, choicen_category, num_exercises=4):
        ...
        chosen_exercises = [
            ...
            if exercise.category.lower() == choicen_category.lower()
        ]
    ...
    def display_workout(self, chosen_category, num_rounds=3, break_time=2):
        ...
        print(
            "Provide {} rounds of each exercise with {} minutes break between rounds.".format(
                num_rounds, break_time
            )
        )
        print(
            "For exercise where you have to use weight, take a weight that you can do 10 reps with per set.\n"
        )
        cyan_color = "\033[36m"
        reset_color = "\033[0m"
        ...
        for index, exercise in enumerate(random_workout, start=1):
            print(
                "{}{}. {}{}".format(
                    yellow_color, index, exercise.description, reset_color
                )
            )
        print(
    ...
    def create_workout_info(self, chosen_category, random_workout):
        ...
        workout_info += (
            "Provide 3 rounds of each exercise with 2 minutes break between rounds.\n"
        )
